  ...
  return <div className="landing">
    ...
    <section className="landing-hero">
      <div>
        ...
        <p className="lede">undelete.chat links to your own chat accounts and keeps the messages other people delete or set to disappear, with the edits they made before deleting. Nothing else is stored.</p>
