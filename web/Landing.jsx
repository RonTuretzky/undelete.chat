  ...
  return <div className="landing">
    ...
    <section className="landing-section" id="faq">
      ...
      <div className="faq">
        ...
        <details><summary>Are photos, voice notes, and files kept?</summary><p>Only their names and types. File bodies and view-once media are never stored. Text in chats with a disappearing timer is held and kept only if deleted, like any other message.</p></details>
