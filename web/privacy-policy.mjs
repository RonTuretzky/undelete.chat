// The privacy policy is generated into the help center and the public docs.
// It describes what the service actually stores, based on the September 2026
// audit of the server, deployment, and provider configuration. Keep it in
// step with the code: when storage or a provider changes, change this first.
export const privacyPolicy = {
  title: 'Privacy policy',
  description: 'What undelete.chat stores, why, for how long, and who can see it.',
  category: 'PRIVACY',
  sections: [
    {
      id: 'summary',
      title: 'In short',
      paragraphs: [
        'undelete.chat watches the personal messaging accounts you link and keeps only messages that were later deleted on the platform. Every other message is held privately for a per-platform watch window and then discarded. The defaults follow each platform’s own deletion limit plus a margin: three days for WhatsApp, two days for Signal, and thirty days for Telegram, which allows deletion at any time. Edits are recorded for one hour, two days, and three days respectively. Both windows are adjustable in Settings. Nothing you did not link is watched, and nothing that was never deleted is kept beyond that window.',
    ...
    },
    {
      ...
      paragraphs: [
        'Held messages: until the end of that platform’s delete window, measured from the last activity on that message.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'The messaging platforms you link (Telegram, WhatsApp, Signal) see a linked device or session named undelete.chat on your account, exactly as they would for a desktop client. We do not send them anything beyond what their protocols require to receive your messages.',
    ...
    },
    {
      ...
      paragraphs: [
        'You can export everything undelete.chat holds for you as JSON from Settings at any time, remove individual messages, disconnect any account, shorten or lengthen the watch window and retention period, and delete your account outright. None of these actions requires contacting us.',
        ...
        'The messages you capture include other people’s words. You are responsible for having a lawful basis to keep them, and for not using undelete.chat to monitor someone without their knowledge where that is unlawful.',
        'undelete.chat is not intended for children under 16 and we do not knowingly create accounts for them.'
      ]
    },
    {
      id: 'changes',
