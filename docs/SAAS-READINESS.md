...
Live phone scans require the account holder. Discord's platform restrictions remain a public-launch risk, and full live access remains unverified. Access/payment configuration, automatic off-site backups, external monitoring, storage scaling, and capacity work remain outstanding. These do not prevent progress on server infrastructure and the other platforms.
